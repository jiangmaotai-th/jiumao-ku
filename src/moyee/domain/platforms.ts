...
export const PLATFORM_PRESETS: PlatformPreset[] = [
  ...
  vp('Instagram 方形', 'instagram-square', 'social', { width: 1080, height: 1080, videoBitrateKbps: 5000 }),
  vp('TikTok', 'tiktok', 'social', { width: 1080, height: 1920, videoBitrateKbps: 5100 }),
  vp('抖音', 'douyin', 'social', { width: 1080, height: 1920, videoBitrateKbps: 5000 }),
  vp('小红书', 'xiaohongshu', 'social', { width: 1080, height: 1920, videoBitrateKbps: 6000 }),
  vp('快手', 'kuaishou', 'social', { width: 1080, height: 1920, videoBitrateKbps: 5500 }),
  vp('头条', 'toutiao', 'social', { width: 1920, height: 1080, videoBitrateKbps: 7500 }),
  vp('微博', 'weibo', 'social', { width: 1080, height: 1920, videoBitrateKbps: 5400 }),
  ...
  vp('视频号', 'wechat-channels', 'social', { width: 1080, height: 1920, videoBitrateKbps: 6200 }),
  vp('淘宝卖家', 'taobao-seller', 'seller', { width: 1080, height: 1080, videoBitrateKbps: 4000, maxDurationSecs: 60 }),
  vp('京东卖家', 'jd-seller', 'seller', { width: 1080, height: 1080, videoBitrateKbps: 4000, maxDurationSecs: 60 }),
  vp('小红书卖家', 'xiaohongshu-seller', 'seller', { width: 1080, height: 1440, videoBitrateKbps: 4500, maxDurationSecs: 60 }),
]
